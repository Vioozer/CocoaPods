...
Pod::Spec.new do |s|
  ...
  s.description  = "Vioozer iOS SDK"

  s.homepage     = "https://www.vioozer.com/"
  ...
  s.license      = "Proprietary and Confidential, use only with explicit signed consent from owner."
  ...
  s.authors              = {
                            "Adam Matan"    => "adam@vioozer.com",
                            "Uri Bornstein" => "uri@vioozer.com"
                           }
  s.social_media_url     = "https://www.facebook.com/vioozer/"
 ...
 #  s.platform     = :ios, "5.0"
  ...
  #
  s.source       = { :git => "https://github.com/Vioozer/CocoaPods.git" , :branch => "CocoaPods_SA"}
